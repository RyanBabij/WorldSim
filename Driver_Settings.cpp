...
Item * inventoryGrid [10][10];
  ...
  // SYSTEM STRINGS
const std::string VERSION_NUMBER = "0.0.188indev";
...
const bool ENABLE_BACKGROUND_SIMULATION = false; /* Generating maps in the background can cause choppy performance when debugging */
