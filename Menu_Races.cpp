#pragma once
#ifndef WORLDSIM_MENU_RACES_CPP
#define WORLDSIM_MENU_RACES_CPP

/* WorldSim: Menu_Races.cpp
	#include "Menu_Races.cpp"

	Lists notable races in the world.
...
class Menu_Races: public GUI_Interface
{
	...
	void init(Mythology* _selectedMythology)
	{
		...
		buttonMythologyDetails.text="Race Details";
	...
	void render()
	{
		...
		else if ( active )
		{
			...
			font8x8.drawText("Races",panelX1,panelY2-20,panelX2,panelY2-5, true, true);
			guiManager.render();
		}
	}
